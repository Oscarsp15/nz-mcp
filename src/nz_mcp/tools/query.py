...
@tool(
    name="nz_explain",
    description=(
        "Return the Netezza EXPLAIN plan text for read-only SQL "
        "(SELECT, WITH...SELECT, or SHOW). "
        "The plan is returned as text; the statement is not executed for data retrieval. "
