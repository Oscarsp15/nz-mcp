...
- **No enmienda el [ADR 0005](../adr/0005-sin-frontend.md).** Sigue sin haber frontend, UI propia ni TUI navegable. Ampliar este rol a la audiencia humana es formato, progreso y redacción en comandos puntuales, no un interfaz interactivo. Si algún día se quisiera un modo interactivo, sería una enmienda aparte a ese ADR, con argumentos propios.
